package com.bookemporium.controller;
...
import com.bookemporium.service.BookService;
import com.bookemporium.service.CartItemService;
import com.bookemporium.service.OrderService;
...
import com.bookemporium.service.impl.UserSecurityService;
import com.bookemporium.utility.MailConstructor;
import com.bookemporium.utility.SecurityUtility;
import com.bookemporium.utility.INConstants;
...
//		if the userName and userEmail is not duplicate
//		or userName and userEmail is not exists 
//		then we will create a new User , as follows : 
...
//		Now we have created User , now we have to generate token 
		String token = UUID.randomUUID().toString();
		userService.createPasswordResetTokenForUser(user, token);
		
		String appUrl = "http://"+request.getServerName()+":"+request.getServerPort()+request.getContextPath();
		
//		This SimpleMailMessage is the java mail , therefore we have to add the dependency for that in the pom.xml file 
//		the dependency is GroupId as javax.mail and ArtifactId as mail , also the version is 1.4.7
//		and this mailConstructor is the Utility  
